...
export function SubscriptionSection() {
  ...
  return (
    <div id="subscription" className="scroll-mt-8 space-y-6">
      {suspended && (
              ...
              >
                ...
                <CardContent className="flex flex-1 flex-col">
                  ...
                  <Button
                    ...
                    disabled={(isCurrent && !suspended) || paying !== null}
      ...
      <p className="text-xs text-muted-foreground">
        {paystackEnabled
          ...
          : 'Paystack is not configured — plans activate instantly in demo mode.'}
      </p>
    </div>
  );
}
